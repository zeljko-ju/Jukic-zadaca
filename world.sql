...
#C:\xampp\mysql\bin\mysql -uroot --default_character_set=utf8 < C:\Users\php\Documents\GitHub\Jukic-zadaca\world.sql
...
-- Dump completed on 2010-09-30 11:01:37select * from country;


#vjezba select, update i delete na gradovima i državama
select * from city;
select name, district from city;

select name, region, surfaceArea from country;
#naziv kolone odvojeno zarezom 
select name, CountryCode, District, 'world' from city;
#svaka stavka select liste može imati zamjensko ime
select name as ime from city;
#možemo više puta izlistavati jedan podatak u tablici
select name, countryCode, name from city;

select * from city where ID=177;

select * from city where name like 'OSIJE%';

update city set population=73000 where ID =2412;
select * from city where ID=2412;
select * from country where name like 'hrvat%';
update country set name='Hrvatska', Population =4100000 where Code ='HRV';
update city set broj_opcina=26 where ID =2412;
