# C:\xampp\mysql\bin\mysql -uroot --default_character_set=utf8 < C:\Users\php\Documents\GitHub\Jukic-zadaca\mjesta.sql
...
#dodan Kitinger 
select * from mjesto;
select postanskibroj, zupanija, 'Osijek' from mjesto;
insert into mjesto (postanskibroj, zupanija, naziv)
values (31993,21, 'Kitiger');
select * from mjesto;
select * from mjesto where naziv like 'Kiti%';